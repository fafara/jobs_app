...
import com.me.njerucyrus.models.Conversation;
...
public class MessagesActivity extends AppCompatActivity {
    ...
    private FirebaseRecyclerAdapter<Conversation, ConvViewHolder> firebaseRecyclerAdapter;
    ...
    protected void onStart() {
        ...
        firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Conversation, MessagesActivity.ConvViewHolder>(options) {
                    ...
                    public ConvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                        ...
                        return new MessagesActivity.ConvViewHolder(view);
                    }

                    @Override
                    protected void onBindViewHolder(@NonNull final ConvViewHolder holder, int position, @NonNull final Conversation model) {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                holder.mView.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        chatIntent.putExtra("postedByUid", list_user_id);
                                        chatIntent.putExtra("fullName", userName);
